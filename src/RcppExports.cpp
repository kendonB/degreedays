...
// spl3_band_daily
NumericMatrix spl3_band_daily(NumericVector t0, NumericVector t1, NumericVector tmin, NumericVector tmax, NumericVector weights);
RcppExport SEXP degreedays_spl3_band_daily(SEXP t0SEXP, SEXP t1SEXP, SEXP tminSEXP, SEXP tmaxSEXP, SEXP weightsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< NumericVector >::type t0(t0SEXP);
    ...
    Rcpp::traits::input_parameter< NumericVector >::type tmax(tmaxSEXP);
    Rcpp::traits::input_parameter< NumericVector >::type weights(weightsSEXP);
    rcpp_result_gen = Rcpp::wrap(spl3_band_daily(t0, t1, tmin, tmax, weights));
    return rcpp_result_gen;
END_RCPP
}
// spl3_band_daily_par
NumericMatrix spl3_band_daily_par(NumericVector t0, NumericVector t1, NumericVector tmin, NumericVector tmax, NumericVector weights);
RcppExport SEXP degreedays_spl3_band_daily_par(SEXP t0SEXP, SEXP t1SEXP, SEXP tminSEXP, SEXP tmaxSEXP, SEXP weightsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< NumericVector >::type t0(t0SEXP);
    ...
    Rcpp::traits::input_parameter< NumericVector >::type tmax(tmaxSEXP);
    Rcpp::traits::input_parameter< NumericVector >::type weights(weightsSEXP);
    rcpp_result_gen = Rcpp::wrap(spl3_band_daily_par(t0, t1, tmin, tmax, weights));
    return rcpp_result_gen;
END_RCPP
}
// days_in_bin_one
